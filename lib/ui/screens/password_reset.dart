                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          error: (_emailController.text.isNotEmpty && !_validateEmail(_emailController.text))
                              ? const Center(
                                  child: Text(
                                    "E-mail inválido",
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: (_emailController.text.isNotEmpty && _validateEmail(_emailController.text))
                          ? () async {
                              _showSuccessDialog();
                            }
                          : null,
                      child: Text("ENVIAR", style: TextStyle(fontSize: 16, color: Theme.of(context).colorScheme.onPrimary)),
                    ),
                  ),
                ],
              ),
